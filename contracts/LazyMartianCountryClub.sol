...
/** 
    ...
    @title Lazy Martian Country Club mint contract
    @author magiclars <https://github.com/magiclars-off>
*/
contract LazyMartianCountryClub is Ownable, ERC721A, Pausable {
    ...
    /// Initialize the Lazy Martian Country Club contract.
    constructor(
        address _teamAddress,
        bytes32 _merkleRoot,
        uint256 _mintStartTime,
        uint256 _allowlistMintStartTime
    ) ERC721A('Lazy Martian Country Club', 'LMCC') {
    ...
    /// allowlistMint allows the sender to Mint a Lazy Martian if supplied with valid MerkleProof
    ...
    /// mint allows the sender to Mint a Lazy Martian
